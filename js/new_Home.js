...
const createInnerHtml = () => {
    //We use the method stringifydate to format the date defined in utility.js
    ...
    for (const empPayrollData of empPayrollList) {
        ...
        <tr>
            ...
            <td><img id=${empPayrollData._id} onclick="remove(this)" alt="delete" src="../assets/delete-black-18dp.svg">
                <img id=${empPayrollData._id} onclick="update(this)" alt="edit" src="../assets/create-black-18dp.svg"></td>
        </tr>
    `;
    }
